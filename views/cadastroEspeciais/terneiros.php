...
<head>
  ...
  <title>Controle de Terneiros</title>
...
<body>
  <div id="navbar"></div>
  <h1 class="text-center titulo-pagina">Cadastro de Terneiros</h1>
  ...
  <script type="text/javascript" src="../../js/controllers/terneiros.js"></script>
