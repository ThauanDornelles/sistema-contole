...
class PuroOrigem
{
    ...
    public function consultarGeral($filtro)
    {
        ...
        $sql = 'select * from puro_origem where 1 = 1';
    ...
    public function consultar()
    {
        ...
        $sql = 'select * from puro_origem where id = ' . $this->getId();
        $result = mysqli_query($con, $sql);
    ...
    public function inserir()
    {
        ...
        $sql =
            "insert into puro_origem (numeroBrinco, numeroPai, numeroMae, data, peso) values ('" .
    ...
    public function excluir()
    {
        ...
        $con = $conexao->getConnection();
        mysqli_select_db($con, 'sistema_controle');
        $sql = 'delete from puro_origem where id = ' . $this->getId();
