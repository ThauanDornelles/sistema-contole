...
class Terneira
{
    ...
    public function consultarGeral($filtro)
    {
        ...
        $sql = 'select * from terneiras where 1 = 1';
    ...
    public function consultar()
    {
        ...
        $sql = 'select * from terneiras where id = ' . $this->getId();
        $result = mysqli_query($con, $sql);
    ...
    public function inserir()
    {
        ...
        $sql =
            "insert into terneiras (numeroBrinco, numeroPai, numeroMae, data, peso) values ('" .
    ...
    public function excluir()
    {
        ...
        $con = $conexao->getConnection();
        mysqli_select_db($con, 'sistema_controle');
        $sql = 'delete from terneiras where id = ' . $this->getId();
