...
class Vaca
{
    ...
    public function consultarGeral($filtro)
    {
        ...
        $sql = 'select * from vacas where 1 = 1';
    ...
    public function consultar()
    {
        ...
        $sql = 'select * from vacas where id = ' . $this->getId();
        $result = mysqli_query($con, $sql);
    ...
    public function inserir()
    {
        ...
        $sql =
            "insert into vacas (numeroBrinco, numeroPai, numeroMae, data, peso) values ('" .
    ...
    public function excluir()
    {
        ...
        $con = $conexao->getConnection();
        mysqli_select_db($con, 'sistema_controle');
        $sql = 'delete from vacas where id = ' . $this->getId();
